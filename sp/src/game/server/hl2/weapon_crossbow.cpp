...
{
	m_bReloadsSingly = false; // BOF: Disable 1-by-1 because crossbow no more
...
void CWeaponCrossbow::PrimaryAttack(void)
{
	...
	// Signal a reload 
	//BOF: garand still has ammo, no more crossbow
...
{
	// BOF: used weapon_pistol code to reload whole clip, not 1-by-1
